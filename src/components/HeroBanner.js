...
const HeroBanner = () => {
  return (
    ...
    Explore Exercises
        ...
        <img src={homeImages} sx={{display:{xs:'none', sm:'none', md:'none'}}}alt='banner' className='homeImages' style={{width:"700px", top: "-237px", right: "40px",height:"900px",position: "absolute",}}/>
